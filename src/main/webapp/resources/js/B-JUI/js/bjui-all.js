...
+function ($) {
    ...
    window.FRAG = {
        ...
        orderby: '<a href="javascript:;" class="Invoicing asc" data-Invoicing-direction="asc" title="#asc#"><i class="fa fa-angle-up"></i></a>' +
                 '<a href="javascript:;" class="Invoicing desc" data-Invoicing-direction="desc" title="#desc#"><i class="fa fa-angle-down"></i></a>'
        ,
